...
pub struct StubsPeriodVerificationPeriodSaml {
    #[serde(rename = "status")]
    pub status: Status,
...
impl StubsPeriodVerificationPeriodSaml {
    pub fn new(status: Status, strategy: Strategy) -> StubsPeriodVerificationPeriodSaml {
        StubsPeriodVerificationPeriodSaml {
            status,
            strategy,
