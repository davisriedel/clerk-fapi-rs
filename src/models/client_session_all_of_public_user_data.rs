...
pub struct ClientSessionAllOfPublicUserData {
    #[serde(
        rename = "first_name",
        default,
...
impl ClientSessionAllOfPublicUserData {
    pub fn new() -> ClientSessionAllOfPublicUserData {
        ClientSessionAllOfPublicUserData {
            first_name: None,
            last_name: None,
