...
pub struct StubsPeriodVerificationPeriodWeb3Signature {
    #[serde(rename = "status")]
    pub status: Status,
...
impl StubsPeriodVerificationPeriodWeb3Signature {
    pub fn new(status: Status, strategy: Strategy) -> StubsPeriodVerificationPeriodWeb3Signature {
