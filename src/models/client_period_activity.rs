...
pub struct ClientPeriodActivity {
    #[serde(rename = "object")]
    pub object: String,
    #[serde(rename = "id")]
    pub id: String,
    ...
    #[serde(rename = "is_mobile", skip_serializing_if = "Option::is_none")]
...
impl ClientPeriodActivity {
    pub fn new(object: String, id: String) -> ClientPeriodActivity {
        ClientPeriodActivity {
            object,
            id,
            device_type: None,
            is_mobile: None,
