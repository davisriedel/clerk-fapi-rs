...
pub async fn create_backup_codes(
...
) -> Result<models::ClientPeriodClientWrappedBackupCodes, Error<CreateBackupCodesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/me/backup_codes", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateBackupCodesError> =
