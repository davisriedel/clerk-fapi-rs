...
pub async fn accept_organization_membership_request(
    ...
    models::ClientPeriodClientWrappedOrganizationMembershipRequest,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceptOrganizationMembershipRequestError> =
...
pub async fn list_organization_membership_requests(
    ...
    models::ClientPeriodClientWrappedOrganizationMembershipRequests,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListOrganizationMembershipRequestsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RejectOrganizationMembershipRequestError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
