...
pub async fn attempt_passkey_verification(
    ...
    let local_var_uri_str = format!(
        ...
        passkey_id = crate::apis::urlencode(passkey_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AttemptPasskeyVerificationError> =
...
pub async fn delete_passkey(
    configuration: &configuration::Configuration,
    passkey_id: &str,
) -> Result<models::ClientPeriodClientWrappedDeletedObject, Error<DeletePasskeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePasskeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_passkey(
    ...
    passkey_id: &str,
    name: Option<&str>,
) -> Result<models::ClientPeriodClientWrappedPasskey, Error<PatchPasskeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchPasskeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_passkey(
    ...
    let local_var_uri_str = format!("{}/v1/me/passkeys", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostPasskeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn read_passkey(
    configuration: &configuration::Configuration,
    passkey_id: &str,
) -> Result<models::ClientPeriodClientWrappedPasskey, Error<ReadPasskeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadPasskeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
